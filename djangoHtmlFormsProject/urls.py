"""
URL configuration for djangoHtmlFormsProject project.
...
urlpatterns = [
    ...
    path('student-detais/', views.student_details, name='students-details-page'),
    path('delete-product/<id>', views.delete_product, name='del-pr'),
    path('update-product/<id>', views.update_product, name='update-prod'),
